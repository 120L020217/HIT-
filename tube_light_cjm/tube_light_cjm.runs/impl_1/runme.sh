...
HD_PWD='D:/Vivado/2018.3/myworkplace/tube_light_cjm/tube_light_cjm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tube_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tube_light.tcl -notrace
