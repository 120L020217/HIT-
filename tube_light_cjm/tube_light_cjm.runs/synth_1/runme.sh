...
HD_PWD='D:/Vivado/2018.3/myworkplace/tube_light_cjm/tube_light_cjm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tube_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tube_light.tcl
