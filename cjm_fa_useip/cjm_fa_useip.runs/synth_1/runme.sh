...
HD_PWD='D:/Vivado/2018.3/myworkplace/cjm_fa_useip/cjm_fa_useip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cjm_fa_useip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cjm_fa_useip.tcl
