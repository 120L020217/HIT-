...
HD_PWD='D:/Vivado/2018.3/myworkplace/cjm_fa_useip/cjm_fa_useip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cjm_fa_useip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cjm_fa_useip.tcl -notrace
