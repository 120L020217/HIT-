...
--               d:/Vivado/2018.3/myworkplace/cjm_fa_useip/cjm_fa_useip.srcs/sources_1/ip/halfadder_0/halfadder_0_sim_netlist.vhdl
-- Design      : halfadder_0
...
entity halfadder_0_halfadder is
  port (
    ain : in STD_LOGIC;
    bin : in STD_LOGIC;
    cout : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of halfadder_0_halfadder : entity is "halfadder";
end halfadder_0_halfadder;

architecture STRUCTURE of halfadder_0_halfadder is
...
entity halfadder_0 is
  ...
  attribute X_CORE_INFO of halfadder_0 : entity is "halfadder,Vivado 2018.3";
end halfadder_0;

architecture STRUCTURE of halfadder_0 is
begin
inst: entity work.halfadder_0_halfadder
     port map (
      ain => ain,
      bin => bin,
      cout => cout,
