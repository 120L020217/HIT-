...
#
# Generated by export_simulation on Thu Nov 18 18:40:47 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './halfadder_1.sh' script.

./halfadder_1.sh -reset_run
...
./halfadder_1.sh -noclean_files

For more information on the script, please type './halfadder_1.sh -help'.
