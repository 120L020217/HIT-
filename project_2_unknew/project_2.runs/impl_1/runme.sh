...
HD_PWD='D:/Vivado/2018.3/myworkplace/project_2_unknew/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log electronic_coded_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source electronic_coded_lock.tcl -notrace
