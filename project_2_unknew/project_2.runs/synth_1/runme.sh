...
HD_PWD='D:/Vivado/2018.3/myworkplace/project_2_unknew/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log electronic_coded_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source electronic_coded_lock.tcl
